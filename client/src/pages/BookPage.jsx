...
function BookPage() {
    ...
    const handleOpenModal = function (book) {
    ...
    const handleUpdateBookPrice = function (bookId, newPrice) {
        ...
        <div className="min-h-screen bg-[#F5F5FA]">
            ...
            <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
                ...
                <div className="mt-8 flex justify-center">
                    <button className="flex items-center gap-2 bg-red-600 text-white px-6 py-2 rounded-md hover:bg-red-700 font-medium transition-colors">
                        Lưu thay đổi{" "}
                    </button>
                </div>
            </main>
