...
namespace DoAnPhanMem.Services.Implementations
{
    public class BaoCaoCongNoService : IBaoCaoCongNoService
    {
        ...
        { 
            ...
            //Không cần phải tạo mới vì tạo khách hàng mới đã có trong hàm UpdateInventoryReportAsync rồi, mà 2 hàm này thì được gọi trong cùng 1 API và cái UpdateInventoryReportAsync đc gọi trc nên khỏi phải lo là khách hàng chưa tồn tại nhá
