    ...
    public partial class InitialCreate_PG : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaKH = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    ...
                    SDT = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Email = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    CongNo = table.Column<decimal>(type: "numeric(18,0)", nullable: false, defaultValue: 0m)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaTG = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    TenTG = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaTL = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    TenTL = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaBCCN = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Thang = table.Column<int>(type: "integer", maxLength: 100, nullable: false),
                    Nam = table.Column<int>(type: "integer", nullable: false),
                    NoDau = table.Column<decimal>(type: "numeric(18,0)", nullable: false),
                    NoPhatSinh = table.Column<decimal>(type: "numeric(18,0)", nullable: false),
                    TraNo = table.Column<decimal>(type: "numeric(18,0)", nullable: false),
                    NoCuoi = table.Column<decimal>(type: "numeric(18,0)", nullable: false),
                    MaKH = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaNV = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    HoTen = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    DiaChi = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    SDT = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaSach = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    TenSach = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MaNV = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    MaKH = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaPhieu = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    MaNV = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    MaPhieu = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    NgayThuTien = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
                    SoTienThu = table.Column<decimal>(type: "numeric(18,0)", nullable: false),
                    MaNV = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: true),
                    MaKH = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_PTT_SoTien", "\"SoTienThu\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    TenQuyDinh = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    GiaTri = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    MaNV = table.Column<string>(type: "character varying(100)", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    MaBCT = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    MaSach = table.Column<string>(type: "character varying(100)", maxLength: 100, nullable: false),
                    Thang = table.Column<int>(type: "integer", maxLength: 100, nullable: false),
                    Nam = table.Column<int>(type: "integer", nullable: false),
                    TonDau = table.Column<int>(type: "integer", nullable: false),
                    PhatSinh = table.Column<int>(type: "integer", nullable: false),
                    DaBan = table.Column<int>(type: "integer", nullable: false),
                    TonCuoi = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DonGiaBan = table.Column<decimal>(type: "numeric(18,0)", nullable: false),
                    NgayLapHoaDon = table.Column<DateTime>(type: "timestamp with time zone", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CHI_TIET_HOA_DON", x => new { x.MaHoaDon, x.MaSach });
                    table.CheckConstraint("CK_CTHD_SoLuong", "\"SoLuong\" > 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_CTPN_SoLuong", "\"SoLuongNhap\" > 0");
                    table.ForeignKey(
