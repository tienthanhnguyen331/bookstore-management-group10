        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TraNo = table.Column<decimal>(type: "decimal(18,0)", nullable: false, defaultValue: 0m),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DaBan = table.Column<int>(type: "int", nullable: false, defaultValue: 0),
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { "QD1_NhapToiThieu", "150", null },
                    { "QD1_TonToiDaTruocNhap", "300", null },
                    { "QD2_NoToiDa", "20000", null },
                    { "QD2_TonToiThieuSauBan", "20", null },
                    { "QD4_KiemTraTienThu", "1", null }
                });
            ...
            // Index on TenDangNhap for KHACH_HANG removed per model changes
            ...
            // Ensure TenDangNhap column is removed from KHACH_HANG if present (safety for reapply)
            migrationBuilder.Sql(@"
IF EXISTS(SELECT 1 FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_NAME = 'KHACH_HANG' AND COLUMN_NAME = 'TenDangNhap')
BEGIN
    ALTER TABLE [KHACH_HANG] DROP COLUMN [TenDangNhap];
END");
        }
