...
{
    c.AddSecurityDefinition("Bearer", new OpenApiSecurityScheme // Đổi từ "oauth2" thành "Bearer"
    {
        Name = "Authorization", // Tên header
        Type = SecuritySchemeType.ApiKey, // Thay đổi từ Http sang ApiKey
        Scheme = "Bearer", // Đặt là Bearer
        BearerFormat = "JWT", // Định dạng token
        In = ParameterLocation.Header, // Ở trong header
        Description = "Enter: Bearer <token>" // Mô tả hướng dẫn
    });
